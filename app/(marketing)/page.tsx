...
export default function MarketingPage() {
  return (
    <div className="font-sans" style={{ background: "#F5F5F7", color: "#0A0A0B" }}>
      ...
      {/* ── HERO — the blob is the page ── */}
      <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-6">

        {/* Blob — behind the type */}
        <div className="animate-drift pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
          <MorphBlob size={680} />
        </div>

        {/* Type — overlapping the object */}
        ...
        {/* Scroll hint */}
        <div className="animate-fade-in absolute bottom-10 left-1/2 -translate-x-1/2" style={{ animationDelay: "1.4s" }}>
      ...
      {/* ── CAPABILITIES — numbered, editorial ── */}
