...
// Temporarily halt billing. (Transitions state to paused).
export async function POST(
    req: NextRequest,
    ctx: RouteContext<"/api/customers/[customerId]/subscriptions/[subscriptionId]/pause">,
) {
    ...
    if (error$3 !== null) {
        logger.withTag(req.url).error("Could not pause subscription:", error$3);
        return structuredResponse(STATUS_INTERNAL_SERVER_ERROR, DUMMY_500_MESSAGE);
    }
