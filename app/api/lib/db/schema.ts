...
export const subscribers = pgTable(
    ...
    (table) => [
        index("subscriptions_appId_idx").on(table.appId),
        uniqueIndex("appId_userId_idx").on(table.appId, table.appId),
...
export const subscriberCards = pgTable(
    ...
    (table) => [
        index("subscriptions_subscriberId_idx").on(table.subscriberId),
        index("subscriptions_created_at_idx").on(table.createdAt),
        foreignKey({
